...
public class Point implements Comparable<Point> {
    ...
    private static final Comparator<Point> BY_SLOPE_ORDER = new BySlopeOrder();
    /**
    ...
    public double slopeTo(Point that) {
    	...
    	int x1=that.x;
        int y1=that.y;
    	if(x == x1) return Double.POSITIVE_INFINITY;
    ...
    /**
     * Comparator object that will use slopeOrder for the required compare method 
     * @author sudeep
     *
     */
